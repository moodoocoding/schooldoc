      ...
      <div className="grid gap-6 xl:grid-cols-[420px_minmax(0,1fr)]">
        <div className="space-y-5">
          ...
          <section className="border-y border-[#DCE3EA] bg-white px-4 py-5 sm:px-5">
            ...
            <div className="flex items-center justify-between gap-3"><div><p className="text-xs font-bold text-[#526174]">먼저 할 일</p><h2 className="mt-1 text-sm font-bold">원본 PDF 올리기</h2><p className="mt-1 text-xs text-[#64748B]">PDF · 최대 30MB</p></div>{analysis ? <button type="button" onClick={resetFile} className="inline-flex h-10 w-10 items-center justify-center rounded-lg text-[#526174] hover:bg-[#F6F8FB]" aria-label="원본 파일 다시 선택" title="다시 선택"><RotateCcw className="h-4 w-4" /></button> : null}</div>
