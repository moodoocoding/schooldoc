import { ArrowLeft, FileCheck2, FileText, Plus, Trash2 } from 'lucide-react';
...
import { deleteRemoteConsentForm, listRemoteConsentForms } from './consentFormsRepository';
...
export function ConsentFormsListPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      else await deleteRemoteConsentForm(pendingDelete.id);
