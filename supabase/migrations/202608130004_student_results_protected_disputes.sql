...
drop policy if exists "Teachers observe protected student result recipients" on public.student_result_recipients;
...
drop policy if exists "Teachers observe protected student result disputes" on public.student_result_disputes;
